...
2. 举证质证·原告：法官请原告举证→${userRole === 'plaintiff' ? '用户举证→对方律师质证' : '对方律师举证→用户质证'}→法官（追问或安排下一轮或推进）
3. 举证质证·被告：法官请被告举证→${userRole === 'plaintiff' ? '对方律师举证→用户质证' : '用户举证→对方律师质证'}→法官（追问或安排下一轮或推进）
4. 法庭辩论：法官宣布→${userRole === 'plaintiff' ? '用户→对方律师→用户→对方律师' : '对方律师→用户→对方律师→用户'}→循环。如果双方观点开始重复、没有新论点→输出"法官"让法官宣布结束。法官也可以在辩论过程中随时插入发言
5. 最终陈述：法官宣布→${userRole === 'plaintiff' ? '用户陈述→对方律师陈述' : '对方律师陈述→用户陈述'}→法官（确认或推进）
6. 裁决：法官作出裁决→结束
