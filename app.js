...
3. 法庭辩论：法官宣布进行法庭辩论→${userRole === 'plaintiff' ? '用户发言→法官请对方律师回应→对方律师发言' : '对方律师发言→法官请用户回应→用户发言'}→法官决定是否继续（继续则重复上述循环）。双方各发言2-3轮后（一轮=双方各说一次），如果没有出现全新的论点或证据，应立即输出"法官"让法官收场，不要继续安排律师发言。
4. 最终陈述：法官宣布进行最终陈述→${userRole === 'plaintiff' ? '用户陈述→法官请对方律师陈述→对方律师陈述' : '对方律师陈述→法官请用户陈述→用户陈述'}→法官（确认或推进）
5. 裁决：法官作出裁决→结束
