...
2. 举证质证·原告：法官请原告举证→${userRole === 'plaintiff' ? '用户举证→法官请对方律师质证→对方律师质证' : '对方律师举证→法官请用户质证→用户质证'}→法官（追问或安排下一轮或推进）
3. 举证质证·被告：法官请被告举证→${userRole === 'plaintiff' ? '对方律师举证→法官请用户质证→用户质证' : '用户举证→法官请对方律师质证→对方律师质证'}→法官（追问或安排下一轮或推进）
4. 法庭辩论：法官宣布→${userRole === 'plaintiff' ? '用户发言→法官请对方律师回应→对方律师发言' : '对方律师发言→法官请用户回应→用户发言'}→法官决定是否继续（继续则重复上述循环）。如果双方观点开始重复、没有新论点→输出"法官"让法官宣布结束。法官在发言时也可以进行实质提问
5. 最终陈述：法官宣布→${userRole === 'plaintiff' ? '用户陈述→法官请对方律师陈述→对方律师陈述' : '对方律师陈述→法官请用户陈述→用户陈述'}→法官（确认或推进）
6. 裁决：法官作出裁决→结束
...
庭审阶段编号对照：
0=开庭陈述  1=归纳争议焦点  2=举证质证·原告  3=举证质证·被告  4=法庭辩论  5=最终陈述  6=裁决
